...
The combined dataset is `r nrow(pols_snp_unemployment)` rows and `r ncol(pols_snp_unemployment)`, and contains data from the years within (`r range(pull(pols_snp_unemployment, Year))`). Key variables include month and year, closing value of the SNP, party affiliation of the president and unemployment percentage.
